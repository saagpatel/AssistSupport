      ...
      {!status ? (
        ...
        <div className="batch-input-section">
          <div className="batch-instructions">
            <p>
              Enter one support query per line. Each will be processed with KB
        ...
        <div className="batch-results-section">
          ...
          {status.status === "running" && (
            <div className="batch-processing-indicator">
              ...
              <span>
                Processing query {status.completed + 1} of {status.total}...
              </span>
            </div>
          )}
          ...
          <div className="batch-actions">
            {status.status === "running" && (
              <Button variant="ghost" onClick={cancelBatch}>
                Cancel
              </Button>
            )}
            {(status.status === "succeeded" ||
