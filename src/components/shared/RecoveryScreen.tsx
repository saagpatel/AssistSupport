      ...
      <section className="recovery-card" aria-labelledby="recovery-title">
        <div className="recovery-header">
          ...
          <div>
            ...
            <p className="recovery-subtitle">
              AssistSupport opened in recovery mode so you can repair the
              workspace before normal startup continues.
            </p>
          </div>
        </div>
        ...
        <div className="recovery-body">
          ...
          <div className="recovery-notes">
            ...
            <ul>
              <li>
                Drafts, templates, custom variables, custom trees, settings, and
                knowledge-base folder configuration are restored.
              </li>
              <li>
                Knowledge-base source files, attachments, models, and vector
                embeddings are not included in the backup file.
              </li>
              <li>
                After recovery, re-index the knowledge base and regenerate
                embeddings if you use local semantic search.
              </li>
            </ul>
          </div>
        </div>
