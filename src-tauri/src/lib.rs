...
pub fn run() {
    ...
    let builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::update_kb_gap_status,
            commands::run_deployment_preflight,
            commands::record_deployment_artifact,
            commands::get_deployment_health_summary,
            commands::list_deployment_artifacts,
            commands::verify_signed_artifact,
            commands::rollback_deployment_run,
            commands::run_eval_harness,
            commands::list_eval_runs,
            commands::cluster_tickets_for_triage,
            commands::list_recent_triage_clusters,
            commands::start_runbook_session,
            ...
            commands::product_workspace::add_runbook_step_evidence,
            commands::configure_integration,
            commands::list_integrations,
            commands::product_workspace::list_resolution_kits,
            commands::product_workspace::save_resolution_kit,
            commands::product_workspace::list_workspace_favorites,
            commands::product_workspace::save_workspace_favorite,
            commands::product_workspace::delete_workspace_favorite,
            commands::product_workspace::preview_collaboration_dispatch,
            commands::product_workspace::confirm_collaboration_dispatch,
            commands::product_workspace::send_collaboration_dispatch,
            commands::product_workspace::cancel_collaboration_dispatch,
            commands::product_workspace::list_dispatch_history,
            commands::product_workspace::save_case_outcome,
            commands::product_workspace::list_case_outcomes,
            commands::set_workspace_role,
            commands::list_workspace_roles,
