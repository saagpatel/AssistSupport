...
- [src-tauri/src/db/mod.rs](../../src-tauri/src/db/mod.rs) had grown into a mixed bootstrap, migration, runtime-state, draft, knowledge, analytics, workspace, and test file.
